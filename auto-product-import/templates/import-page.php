...
<div class="wrap">
    ...
    <div class="apm-admin">
        <div class="apm-import-container">
            <div class="apm-import-form-container">
                ...
                <form id="apm-import-form" class="apm-import-form">
                    ...
                    <p class="submit">
                        ...
                        <button type="button" id="apm-batch-import-btn" class="button button-primary">
                            <?php _e('Batch Import', 'auto-product-import'); ?>
                        </button>
                        <span class="spinner" style="float: none; margin-top: 0;"></span>
                        <span class="apm-batch-progress" style="display: none;"></span>
                    </p>
                </form>
                
                <!-- PDF Documents toggle removed in v2.2.2 -->
                <!-- PDFs are still scraped and uploaded to media library -->
            ...
            <?php
            // Render import queue section
            if (class_exists('APM_Import_Queue_Manager')) {
                $queue_manager = new APM_Import_Queue_Manager();
                $queue_manager->render_queue_section();
            }
            ?>
        </div>
    </div>
