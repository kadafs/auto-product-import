...
class APM_Admin_Menu {
    ...
    public function render_import_page() {
        ...
        include APM_PLUGIN_DIR . 'templates/import-page.php';
    }
    ...
    public function render_settings_page() {
        ...
        include APM_PLUGIN_DIR . 'templates/settings-page.php';
    }
    ...
    public function render_import_form_shortcode($atts) {
        ...
        wp_enqueue_script('apm-frontend', APM_PLUGIN_URL . 'assets/frontend.js', array('jquery'), APM_VERSION, true);
        ...
        ob_start();
        include APM_PLUGIN_DIR . 'templates/import-form.php';
        return ob_get_clean();
    }
}
